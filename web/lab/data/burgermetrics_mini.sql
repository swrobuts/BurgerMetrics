...
INSERT INTO dim_product (product_id, product_name, category, subcategory, is_vegetarian, unit_price) VALUES
  (4, 'Bacon King', 'Burger', 'Beef', FALSE, 10.51),
  (5, 'Chicken Burger', 'Burger', 'Chicken', FALSE, 7.88),
  (8, 'Kids Burger', 'Burger', 'Kids', FALSE, 3.93),
  (10, 'Beyond Burger', 'Burger', 'Vegan', TRUE, 10.51),
  (13, 'Green Goddess Bowl', 'Burger', 'Vegan', TRUE, 11.82),
  (15, 'Small Fries', 'Side', 'Fries', TRUE, 2.62),
  (16, 'Medium Fries', 'Side', 'Fries', TRUE, 3.27),
  (17, 'Large Fries', 'Side', 'Fries', TRUE, 3.93),
  (18, 'Chicken Nuggets 6pc', 'Side', 'Nuggets', FALSE, 4.59),
  (20, 'Onion Rings', 'Side', 'Fried', TRUE, 3.93),
  (21, 'Side Salad', 'Side', 'Salad', TRUE, 3.93),
  (22, 'Coleslaw', 'Side', 'Salad', TRUE, 3.01),
  (26, 'Cola 0.3l', 'Drink', 'Soft Drink', TRUE, 2.88),
  (27, 'Cola 0.5l', 'Drink', 'Soft Drink', TRUE, 3.8),
  (28, 'Fanta 0.3l', 'Drink', 'Soft Drink', TRUE, 2.88),
  (29, 'Sprite 0.3l', 'Drink', 'Soft Drink', TRUE, 2.88),
  (31, 'Ice Tea 0.3l', 'Drink', 'Soft Drink', TRUE, 3.27),
  (32, 'Coffee', 'Drink', 'Hot Drink', TRUE, 2.62),
  (33, 'Cappuccino', 'Drink', 'Hot Drink', TRUE, 3.93),
  (34, 'Milkshake Vanilla', 'Drink', 'Milkshake', TRUE, 5.25),
  (36, 'Milkshake Strawberry', 'Drink', 'Milkshake', TRUE, 5.25),
  (37, 'Fresh OJ', 'Drink', 'Juice', TRUE, 4.19),
  (38, 'Beer 0.3l', 'Drink', 'Alcohol', TRUE, 4.59),
  (39, 'Hot Chocolate', 'Drink', 'Hot Drink', TRUE, 4.19),
  (40, 'Craft Lemonade', 'Drink', 'Soft Drink', TRUE, 4.59),
  (42, 'Soft Ice Chocolate', 'Dessert', 'Ice Cream', TRUE, 2.35),
  (45, 'Apple Pie', 'Dessert', 'Pastry', TRUE, 2.62),
  (46, 'Cookie Chocolate', 'Dessert', 'Pastry', TRUE, 1.7),
  (49, 'Breakfast Burger', 'Breakfast', 'Burger', FALSE, 5.9),
  (54, 'Ketchup Extra', 'Extra', 'Sauce', TRUE, 0.53),
  (56, 'BBQ Sauce', 'Extra', 'Sauce', TRUE, 0.53);
