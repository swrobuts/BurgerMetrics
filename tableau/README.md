...
Parameter `Jahr`, die 27 Calculated Fields aus `web/lab/vorlagen/tableau-dashboard-felder.txt`,
elf Blätter und das Dashboard „Dashboard 1“ (1600 × 1100). Gebaut und geprüft am
...
Blätter       Filialen Umsatz, Filialen Kennzahlen, Umsatz je Monat, Abweichung je Monat,
              ...
              Karte Bestellwert, Karte Sterne, Titel
Dashboard 1   vertikaler Container als Rahmen: Titel, Kartenreihe, mittlere Reihe aus
              ...
              Dropdown unverankert oben rechts
```
